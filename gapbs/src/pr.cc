...
int main(int argc, char* argv[]) {
  ...
  Graph g = b.MakeGraph();
  auto PRBound = [&cli, &scores, &outgoing_contrib] (const Graph &g) -> pvector<ScoreT>& {
    return PageRankPullGS(g, cli.max_iters(), scores, outgoing_contrib,
                          cli.tolerance(), cli.logging_en());
  };
